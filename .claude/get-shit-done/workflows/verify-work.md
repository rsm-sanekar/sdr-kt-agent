...
<template>
@/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/workflows/diagnose-issues.md
