...
- **Global scope**: `/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/notes/`)
...
2. Glob `/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/notes/` — works in any directory
