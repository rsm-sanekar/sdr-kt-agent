...
```bash
node "/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/templates/retrospective.md`.
