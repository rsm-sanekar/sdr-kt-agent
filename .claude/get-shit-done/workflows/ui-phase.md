...
```markdown
Read /Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/agents/gsd-ui-checker.md for instructions.
