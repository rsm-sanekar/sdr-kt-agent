...
```
Task(
  prompt="Read /Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/templates/SECURITY.md`
