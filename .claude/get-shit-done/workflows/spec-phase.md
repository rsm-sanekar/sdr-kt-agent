...
```bash
INIT=$(node "/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/templates/spec.md.
