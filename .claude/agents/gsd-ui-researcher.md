...
Use template from `/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/templates/UI-SPEC.md`
