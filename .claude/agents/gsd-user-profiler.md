...
<reference>
@/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/references/user-profiling.md` to load:
