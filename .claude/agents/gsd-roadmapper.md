...
Reference full template: `/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/shreyaanekar/git/GenAI/sdr-kt-agent/.claude/get-shit-done/templates/state.md`.
